package com.itcen.emergencyroad.findpath.controller;//package com.itcen.emergencyroad.findpath.controller;
// 사용자의 요청을 받는 코드
// 가장 먼저 실행됨
...
public class KakaoMobilityController {
    ...
    // 비즈니스 로직 불러옴.
    private final KakaoMobilityService kakaoService;
    ...
    public ResponseEntity<List<PathResponseDto>> findHospitals(@RequestBody LocationRequestDto requestDto) {
        ...
        List<PathResponseDto> resultList = kakaoService.findHospitalsWithDistance(requestDto, hospitals);
